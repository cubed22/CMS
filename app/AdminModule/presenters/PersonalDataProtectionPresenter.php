...
/**
 * Presenter for managing personal data protection settings in the admin panel.
 */
final class PersonalDataProtectionPresenter extends AdminPresenter
{
	/** @var Model\Url */
	...
	/**
	 * Constructor for PersonalDataProtectionPresenter.
	 *
	 * @param Model\Url $url
	 * @param Model\PersonalDataProtections $model
	 */
	public function __construct( Model\Url $url, Model\PersonalDataProtections $model)
	{
		parent::__construct();
		$this->model = $model;
		$this->url = $url;
	...
	/**
	 * Action to display detail of personal data protection settings.
	 *
	 * @return void
	 */
